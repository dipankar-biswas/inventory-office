    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box ptb--100">
                ...
                <form method="POST" action="{{ route('login') }}" id="myForm" autocomplete="off">
                    @csrf
                    <div class="login-form-head">
                        @if(isset($setting->header_logo))
                         <img src="{{ asset($setting->header_logo) }}" 
                            alt="SKB Inventory" class="mw-120 h-51px h-md-51px">
                        @endif
                    </div>
                    <div class="login-form-body">

                        <p class="mb-4" style="margin-top: 5px;margin-bottom: 17px;text-align: center;color: red;" id="msg">{{ session('failure') }}</p>
