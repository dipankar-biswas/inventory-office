                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="rentProduct">Price</label>
                                        <input type="text" name="price" class="form-control" placeholder="Enter Price Name">
                                        @error('price')
                                            <div class="form-text text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="rentProduct">Stock</label>
                                        <input type="text" name="stock" class="form-control" placeholder="Enter Stock Qty">
                                        @error('stock')
                                            <div class="form-text text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="rentProduct">Color</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="rentProduct">Stock</label>
                                        <input type="text" name="size" class="form-control" placeholder="Enter Size Qty">
                                        @error('size')
                                            <div class="form-text text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="rentProduct">Brand</label>
                                        <select class="select-form form-control" name="brand_id">
                                            <option selected>Slect Name</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="rentProduct">Category</label>
