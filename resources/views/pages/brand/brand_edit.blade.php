                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('brand.update',$brands->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ $brands->name }}" class="form-control" placeholder="Enter Brand Name" value="{{old('name')}}">
                                @error('name')
                            ...
                            {{-- <div class="form-group imageChange">
                                ...
                                <img class="imagePreview mt-3 border rounded" src="{{ !empty($brands->image) ? asset($brands->image) : asset('backend/assets/images/no-image.png') }}" alt="Image" style="width:100px;height: 100px;object-fit:contain;">
                            </div> --}}
